...
class CreateModel3D extends StatelessWidget {
  const CreateModel3D({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: blue.withAlpha(100),
      body: Stack(
        children: [
          CustomScrollView(
            slivers: [
              SliverToBoxAdapter(
                child: SizedBox(
                  height: r.hp(100), // Ocupa toda la altura de la pantalla
                  child: Center(
                    child: Container(
                      margin: EdgeInsets.only(top: 45),
                      width: r.wp(90, max: 1600),
                      height: r.hp(90, max: 1000),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    "Estamos construyendo algo excepcional.",
                                    style: TextStyle(color: blue.withAlpha(100), fontWeight: FontWeight.bold, fontSize: 42),
                                  ),
                                ),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    textAlign: TextAlign.center,
                                    "Nuestro equipo está perfeccionando los detalles finales del modelo 3D para ofrecerte una experiencia visual inmersiva, realista y fluida. Queremos que cada ángulo, cada textura y cada interacción refleje la calidad de nuestro diseño.",
                                  ),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(16),
                                  child: Text(
                                    ...
                                    style: TextStyle(color: blue.withAlpha(100), fontWeight: FontWeight.bold, fontSize: 16),
                                  ),
                                ),
                                SizedBox(height: 20),
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(color: blue.withAlpha(100), borderRadius: BorderRadius.circular(16)),
...
//                                           : 'assets/videos/ecobag/ecobag.webm',
//                                   blur: isBlur,
//                                   loop: true,
//                                   showControls: true,
//                                   fit: BoxFit.cover,
