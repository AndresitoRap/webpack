...
final List<CardProduct> cardFindS = [
  CardProduct(
    title: "Diseño que piensa por tí",
    body: "Tecnología funcional en cada costura.",
    image: "assets/img/smartbag/discover1.webp",
    isblack: true,
  ),
  CardProduct(
    title: "Empaca con inteligencia.",
    body: "Optimiza cada entrega, reduce cada error.",
  ...
  CardProduct(
    title: "Más que empaque, una solución.",
    body: "SmartBag® es rendimiento en acción.",
  ...
  CardProduct(
    title: "Versatilidad que empaca todo.",
    body: "Desde café gourmet hasta alta tecnología.",
    image: "assets/img/smartbag/discover8.webp",
  ),
  CardProduct(
    title: "Inteligencia que se ve.",
    body: "No es solo una bolsa. Es Smart.",
    image: "assets/img/smartbag/discover9.webp",
  ),
  CardProduct(
    title: "Lidera con precisión.",
    body: "Empaque premium que habla de tu marca.",
