...
final List<CardProduct> cardFindS = [
  ...
  CardProduct(
    ...
    imageTop: "img/smartbag/discover2_Top.webp",
    imageDown: "img/smartbag/discover2_Down.webp",
  ),
  CardProduct(
    title: "Elegancia y carácter.",
    body: "Empaque elegante que refleja la sofisticación de su marca en cada detalle.",
    image: "img/smartbag/discover3.webp",
    ...
    imageTop: "img/smartbag/discover3_Top.webp",
    imageDown: "img/smartbag/discover3_Down.webp",
  ),
  CardProduct(
    title: "Estructura y contraste 4PRO.",
    body: "Diseño 4PRO: imponente, preciso y estructurado para resaltar su producto.",
    image: "img/smartbag/discover4.webp",
    ...
    imageTop: "img/smartbag/discover4_Top.webp",
    imageDown: "img/smartbag/discover4_Down.webp",
    isblack: true,
  ),
  CardProduct(
    ...
    image: "img/smartbag/discover5.webp",
    ...
    imageTop: "img/smartbag/discover5_Top.webp",
    imageDown: "img/smartbag/discover5_Down.webp",
  ),
  CardProduct(
    title: "Innovación y elegancia.",
    body: "Diseño innovador y estético que crea experiencias extraordinarias.",
    image: "img/smartbag/discover6.webp",
    ...
    imageTop: "img/smartbag/discover6_Top.webp",
    imageDown: "img/smartbag/discover6_Down.webp",
  ),
  CardProduct(
    title: "Empaques con distinción.",
    body: "Sofisticación en cada detalle, elevando su marca con elegancia.",
    image: "img/smartbag/discover7.webp",
    ...
    imageTop: "img/smartbag/discover7_Top.webp",
    imageDown: "img/smartbag/discover7_Down.webp",
  ),
  CardProduct(
    ...
    image: "img/smartbag/discover8.webp",
  ...
  CardProduct(
    ...
    imageTop: "img/smartbag/discover9_Top.webp",
    imageDown: "img/smartbag/discover9_Down.webp",
  ),
  CardProduct(
    title: "Texturas que comunican.",
    body: "Elegancia y carácter en cada superficie.",
    image: "img/smartbag/discover10.webp",
    ...
    imageTop: "img/smartbag/discover10_Top.webp",
    imageDown: "img/smartbag/discover10_Down.webp",
  ),
];
...
final List<CardProduct> cardFindE = [
  CardProduct(
    ...
    image: "img/ecobag/discover1.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover1_Top.webp",
    imageDown: "img/ecobag/discover1_Down.webp",
  ),
  CardProduct(
    title: "Raíces y ligereza.",
    body: "Conexión viva con la tierra.",
    image: "img/ecobag/discover2.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover2_Top.webp",
    imageDown: "img/ecobag/discover2_Down.webp",
  ),
  CardProduct(
    title: "Esencia que despierta.",
    body: "Alma de tradición cafetera.",
    image: "img/ecobag/discover3.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover3_Top.webp",
    imageDown: "img/ecobag/discover3_Down.webp",
  ),
  CardProduct(
    title: "Silueta serena.",
    body: "Elegancia que inspira calma.",
    image: "img/ecobag/discover4.webp",
    isblack: true,
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover4_Top.webp",
    imageDown: "img/ecobag/discover4_Down.webp",
  ),

  CardProduct(
    title: "Eso es inteligente.",
    body: "Diseño simple, resultados extraordinarios.",
    image: "img/ecobag/discover5.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover5_Top.webp",
    imageDown: "img/ecobag/discover5_Down.webp",
  ),
  CardProduct(
    title: "Eso es inteligente.",
    body: "Diseño simple, resultados extraordinarios.",
    image: "img/ecobag/discover6.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover6_Top.webp",
    imageDown: "img/ecobag/discover6_Down.webp",
  ),
  CardProduct(
    title: "Inspiración, hecha empaque.",
    body: "Sutil. Preciso. Atemporal.",
    image: "img/ecobag/discover7.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover7_Top.webp",
    imageDown: "img/ecobag/discover7_Down.webp",
  ),
  CardProduct(
    title: "Diseño que respira equilibrio.",
    body: "Natural. Estético. Consciente.",
    image: "img/ecobag/discover8.webp",
    isblack: true,
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover8_Top.webp",
    imageDown: "img/ecobag/discover8_Down.webp",
  ),
  CardProduct(
    title: "Sutil por fuera. Preciso por dentro.",
    body: "Diseño que acompaña con elegancia.",
    image: "img/ecobag/discover9.webp",
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover9_Top.webp",
    imageDown: "img/ecobag/discover9_Down.webp",
  ),
  CardProduct(
    title: "Ligera por naturaleza.",
    body: "Minimalismo que flota con intención.",
    image: "img/ecobag/discover10.webp",
    isblack: true,
    descriptionTop:
    ...
    imageTop: "img/ecobag/discover10_Top.webp",
    imageDown: "img/ecobag/discover10_Down.webp",
  ),
];
